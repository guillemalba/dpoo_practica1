...
public class Logica {
    ...
    public void fesParelles(String usuari) {
        ...
        if (numFase == 2) {
            //String nomsFase2[] = new String[];
            int guanyadorBatallaFase2[] = new int[2];

            System.out.println("1-" + topBatalla1.length);
            ...
            System.out.println("2-" + topBatalla1.length);
            //mostrem el ranquing
            int m = 0;
            for (int i = 0; i < j; i++) {
            ...
            for (int i = 0; i < topBatalla1.length; i++) {
                //System.out.println(nomsFase2[i]);
                        ...
                        case 2:
                            ...
                            if (jsonFileCompeticio.getCompetition().getPhases().size() == 2) {
                                ...
                                if (topBatalla1[0] == jsonFileCompeticio.getRappers().get(indexUsuari).getPuntuacio() || topBatalla1[1] == jsonFileCompeticio.getRappers().get(indexUsuari).getPuntuacio()) {
                                    System.out.println("Batalla ultima usuari");
                                }
                                else {
                                    fesParelles(usuari);
                            ...
                            numBatalla = 1;
                            if (numFase == jsonFileCompeticio.getCompetition().getPhases().size()) {
                                opcio = 4;
                            }
                        break;
                    }
